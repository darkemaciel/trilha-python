...
def funcao(
    ...
    *args, # RECEBE ARG. POSICIONAL EXTRA (EMPACOTA NUMA TUPLA)
    e, # COMO O *ARGS JÁ CAPTURA OS ARGUMENTOS POSICIONAIS QUE SOBRAREM, O PARÂMETRO "c" E "d" FICA SENDO OBRIGATORIAMENTE COMO ARGUMENTOS POSICIONAIS
       # ALEM DISSO O "e" E "F" FICAM OBRIGATORIAMENTE NOMEADOS JÁ QUE O *args PEGA TODOS OS POSICIONAIS RESTANTES.
    f,
